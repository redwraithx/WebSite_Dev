...
const UnityProjectsFetchClass = () => {
    ...
    const projectInfo = [
        ...
        { gameName: 'Space Shooter Pro 2.5D', engineName: 'Unity', codeLanguage: 'C#', numberOfMonthsToCreate: 2, createdBy: 'Brian Purdy', description: 'A 2D game using 3d styled assets within 3d space.', videoURL: '',  imgURL: '', gitHubURL: '', playOrDownloadURL: 'https://github.com/redwraithx/Space-Shooter-Pro-2.5D', comingSoonIMG: '/Images/ProjectImages/coming-soon.png' },
