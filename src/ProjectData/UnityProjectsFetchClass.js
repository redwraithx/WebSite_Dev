...
const UnityProjectsFetchClass = () => {
    ...
    const projectInfo = [
        ...
        { gameName: 'Reel Time', engineName: 'Unity', codeLanguage: 'C#', numberOfMonthsToCreate: 1, createdBy: 'Brian Purdy, Owen Hooper, Jonas and Poppinoffski', description: 'This is a game similar to ‘Flappy Birds’ (Dong Nguyen) only the player catches fish and powerups as well as dodging trash in the water. Another feature is the player’s ability to reverse time if the player has obtained the resource needed to do so. ', videoURL: 'ht87KKlASGA',  imgURL: '', gitHubURL: '', playOrDownloadURL: 'https://redwraithx.itch.io/reeltime', comingSoonIMG: '/Images/ProjectImages/coming-soon.png' },
