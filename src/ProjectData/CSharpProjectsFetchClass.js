...
const CSharpProjectsFetchClass = () => {
    ...
    const projectInfo = [
        { gameName: 'Network COM Room Tester', engineName: 'C# WinAPP', codeLanguage: 'C#', numberOfMonthsToCreate: 1, createdBy: 'Brian Purdy', description: 'This was used to test communication rooms for their online status during the construction phase of a new convention centre. ', videoURL: 'UQlD3zxqHXU',  imgURL: '', gitHubURL: 'https://github.com/redwraithx/NetworkComRoomTester', playOrDownloadURL: 'http://www.google.ca', comingSoonIMG: '/Images/ProjectImages/coming-soon.png' },
        { gameName: 'BoardGame Dice Roller', engineName: 'C# WinAPP', codeLanguage: 'C#', numberOfMonthsToCreate: 1, createdBy: 'Brian Purdy', description: 'This Dice-Rolling App was created to roll the die for a board game I created. It uses cryptography to give better random rolls.', videoURL: '_8yQL14sUYs',  imgURL: '', gitHubURL: 'https://github.com/redwraithx/Dice-Roller', playOrDownloadURL: 'http://www.google.ca', comingSoonIMG: '/Images/ProjectImages/coming-soon.png' },
        { gameName: 'BoardGame Random Card Selector', engineName: 'C# WinAPP', codeLanguage: 'C#', numberOfMonthsToCreate: 1, createdBy: 'Brian Purdy', description: 'This Random Card Selector App was created to allow the player to receive random cards from 2 different pools.', videoURL: 'kWTEFGRGDdk',  imgURL: '', gitHubURL: 'https://github.com/redwraithx/Random-Card-Selector', playOrDownloadURL: 'http://www.google.ca', comingSoonIMG: '/Images/ProjectImages/coming-soon.png' },
        { gameName: 'BoardGame Player Info Tracker', engineName: 'C# WinAPP', codeLanguage: 'C#', numberOfMonthsToCreate: 1, createdBy: 'Brian Purdy', description: 'This App was created to keep track of all the players’ game info including status, health, and movement. Because this game is played virtually, it also allows the player to see how his/her competitors\' stats are faring at any given time and probits cheating.', videoURL: 'HSFlOn0U2BU',  imgURL: '', gitHubURL: 'https://github.com/redwraithx/BoardGame-Player-Info-Tracker', playOrDownloadURL: 'http://www.google.ca', comingSoonIMG: '/Images/ProjectImages/coming-soon.png' },
