...
const CSharpProjectsFetchClass = () => {
    ...
    const projectInfo = [
        { gameName: 'Network COM Room Tester', engineName: 'C# WinAPP', codeLanguage: 'C#', numberOfMonthsToCreate: 1, createdBy: 'Brian Purdy', description: 'This was used to test communication rooms for there online state during thier construction.', videoURL: '',  imgURL: '', gitHubURL: 'https://github.com/redwraithx/NetworkComRoomTester', playOrDownloadURL: 'http://www.google.ca', comingSoonIMG: '/Images/ProjectImages/coming-soon.png' },
